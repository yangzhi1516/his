...
public class HospitalizationServiceImpl implements HospitalizationService {
	...
	public int addHospitalization(Hospitalization hospitalization) {
		...
		return iHospitalizationDao.addHospitalization(hospitalization);
	}
	...
	@Override
	public List<Hospitalization> findApplyHospitalization() {
		// TODO Auto-generated method stub
		return iHospitalizationDao.findApplyHospitalization();
	}
