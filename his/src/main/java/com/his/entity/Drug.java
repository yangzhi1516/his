...
public class Drug implements Serializable{
	...
	public String toString() {
		return "Drug [drugId=" + drugId + ", drugName=" + drugName + ", drugNumber=" + drugNumber + ", drugPrice="
				+ drugPrice + ", drugManufacturerId=" + drugManufacturerId + ", drugModifydate=" + drugModifydate
				+ ", drugCreatedate=" + drugCreatedate + ", drugDescription=" + drugDescription + ", manufacturer="
				+ manufacturer + "]";
	}
