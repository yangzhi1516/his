    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 药品表格
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="drugNumber" label="库存"></el-table-column>
                <el-table-column prop="drugPrice" label="价格"></el-table-column>
                <el-table-column prop="drugDescription" label="描述"></el-table-column>
                <el-table-column prop="manufacturer.manufacturerName" label="生产厂商"></el-table-column>
                <el-table-column prop="manufacturer.manufacturerTelephone" label="联系电话"></el-table-column>
                <el-table-column prop="drugModifydate" :formatter="formatDate" label="进货日期"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.$axios.post('/findAllDrug', {withCredentials:true})
        ...
        formatDate(row, column) {
            if(row.drugModifydate!=null){
            // 获取单元格数据
            let data = row.drugModifydate;
